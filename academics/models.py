...
class AcademicYearQuerySet(models.QuerySet):
    ...
    def current(self):
        """
        Returns the academic year that includes today's date.
        """
...
class AcademicYear(models.Model):
    ...
    def clean(self):
        """
        Prevent invalid date ranges and overlapping academic years.
        """
    ...
    def is_current(self):
        """
        Check if this academic year is the current one.
        """
...
class Term(models.Model):
    ...
    def clean(self):
        ...
        if overlapping.exists():
            ...
            raise ValidationError(
                "Term dates overlap with another term in this academic year."
            )

        # Limit to 3 terms per academic year
        ...
        if term_count >= 3:
            ...
            raise ValidationError(
                "An academic year can only have 3 terms."
            )
